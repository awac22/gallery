...
<div class="col-lg-3 col-xxl-2">
    <div class="author-widget">
     ...
     @endif
      ...
      <li class="author-widget-menu-has-child {{activeMenu(['user.withdraw','user.withdraw.preview','user.withdraw.history'],1)}}">
        <a class="{{activeMenu(['user.withdraw','user.withdraw.preview','user.withdraw.history'],2)}}" href="javascript:void(0)" ><i class="las la-file-invoice-dollar"></i> @lang('Withdraw')</a>
        <ul class="author-widget-submenu">
          <li><a  href="{{route('user.withdraw')}}" class="{{activeMenu('user.withdraw',2)}}"><i class="las la-dot-circle"></i>@lang('Withdraw Methods')</a></li>
	...
	<li><a href="https://anywhereanycity.com/support/" class="" target="_blank"><i class="las la-ticket-alt"></i> @lang('Support Ticket')</a></li>
