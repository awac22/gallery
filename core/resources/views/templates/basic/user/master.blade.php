        ...
        <nav class="navbar navbar-expand-xl p-0 align-items-center">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav main-menu m-auto">
              <li> <a href="{{route('home')}}">Gallery Home</a></li>
              ...
              @foreach($pages as $k => $data)
				@auth
					@if($data->name != 'Services')
					  @if($data->name == 'About')
						  <li class="nav-item"><a href="{{route('pages',[$data->slug])}}"  class="nav-link">About Gallery</a></li>
					  @else
            ...
            <div class="nav-right">
              @if (auth()->user()->con_flag == 0)
                <a href="{{route('user.migrate')}}" class="signin-btn mr-2">@lang('Migrate to Photo Seller')</a>  
              @endif         
