        ...
        <div class="col-lg-8">
          ...
          <div class="photo-details-meta mt-4">
            <div class="left">
              ...
              @if (auth()->guest())
              <a href="https://anywhereanycity.com/home/login/" class="cmn-btn btn-sm ml-md-4 mt-md-0 mt-3 follow"><i class="las la-plus"></i> @lang('Follow')</a>
              @else
            ...
            <div class="widget">
              ...
              <div class="image-action-meta mt-4">
               ...
               @if ($user)
                  ...
                  @endif
                  @else
                  <a href="https://anywhereanycity.com/home/login/" class="border-btn btn-sm"><i class="far fa-heart"></i></a>
                  <a title="Report this photo" href="https://anywhereanycity.com/home/login/" class="border-btn btn-sm"><i class="lab la-font-awesome-flag"></i></a>
                  @endif
                ...
                @else
                <a href="https://anywhereanycity.com/home/login/" class="border-btn btn-sm"><i class="fas fa-folder-plus mr-2"></i> @lang('Collect')</a>
                <a href="https://anywhereanycity.com/home/login/" class="border-btn btn-sm"><i class="far fa-comments"></i></a>
                @endif
