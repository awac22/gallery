...
@section('panel')
 ...
 <div class="row">
            <div class="col-md-12">	
<select style="color:#000;border: 2px solid #000;height: 40px;width: 250px;" name="admin" onchange="admin(this.value);" class="admin_change btn btn-outline-light"> 
									<option value="">Select Admin</option>
												<option value="https://anywhereanycity.com/home/login/admin?e={{auth()->guard('admin')->user()->email}}">Home</option>
												<option value="https://anywhereanycity.com/awactv?e={{auth()->guard('admin')->user()->email}}">AWACTV</option>
												<option value="https://awacradio.anywhereanycity.com/?e={{auth()->guard('admin')->user()->email}}">AWACRADIO</option>
												<option value="https://anywhereanycity.com/art/?e={{auth()->guard('admin')->user()->email}}">Art</option>
												<option value="https://anywhereanycity.com/gallery/?e={{auth()->guard('admin')->user()->email}}">Gallery</option>
												<option value="https://events.anywhereanycity.com/?e={{auth()->guard('admin')->user()->email}}">Events</option>
												<option value="https://anywhereanycity.com/fashion/?e={{auth()->guard('admin')->user()->email}}">Fashion</option>
												<option value="https://anywhereanycity.com/marketplace/?e={{auth()->guard('admin')->user()->email}}">Marketplace</option>
												<option value="https://anywhereanycity.com/network/?e={{auth()->guard('admin')->user()->email}}">Network</option>
												<option value="https://anywhereanycity.com/support/?e={{auth()->guard('admin')->user()->email}}">Support</option>
